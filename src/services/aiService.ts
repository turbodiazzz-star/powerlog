...
Дай короткий, конкретный ответ на русском языке в формате Markdown. Максимум 8 коротких пунктов и 1200 знаков. Не повторяй исходные данные, не пиши общие фразы и длинные вступления.
Структура ответа:
